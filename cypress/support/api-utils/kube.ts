...
export const getNamespace = (namespace) => {
  ...
  let options = {
    method: 'GET',
    url: constants.apiUrl + '/api/v1/namespaces/' + namespace,
    headers: headers,
...
export const createNamespace = (namespace) => {
  ...
  let options = {
    method: 'POST',
    url: constants.apiUrl + '/api/v1/namespaces',
    body: `{
            "apiVersion": "v1",
            "kind": "Namespace",
            "metadata": {
...
export const getSecret = (secretName, namespace) => {
  ...
  let options = {
    method: 'GET',
    url: constants.apiUrl + '/api/v1/namespaces/' + namespace + '/secrets/' + secretName,
    headers: headers,
    failOnStatusCode: false,
  }
  return cy.request(options).then((resp) => {
...
export const createSecret = (secretName, namespace, type, data) => {
  ...
  let options = {
    method: 'POST',
    url: constants.apiUrl + '/api/v1/namespaces/' + namespace + '/secrets',
    headers: headers,
    body: `{
            "apiVersion": "v1",
            "kind": "Secret",
