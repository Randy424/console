...
export CYPRESS_SPOKE_CLUSTER="cypress-test-cluster-i"
...
export CYPRESS_ACM_NAMESPACE=${CYPRESS_ACM_NAMESPACE:-"open-cluster-management"}
export CYPRESS_MCE_NAMESPACE=${CYPRESS_MCE_NAMESPACE:-"multicluster-engine"}
